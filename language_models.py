...
from fastchat.conversation import register_conv_template, Conversation
...
class LanguageModel():
    ...
    def evaluate_log_likelihood(self, prompt, output):
        ...
        """
        print("Warning! the function evaluate_log_likelihood is not implemented "
              f"for class {type(self)}, return 0 by default")
        return 0
